...
pnpm exec antora antora-local-playbook.yml
...
* **ftn-site-vercel** - Located in the `ftn-site-vercel` repository (`docs/`)
* **foodtrucknerdzsite** - Located in the `FoodTruckNerdzSite` repository (`docs/`)
