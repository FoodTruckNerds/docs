...
│   ├── antora-playbook-local.yml # Local development playbook
│   ├── build/
...
├── docs/                       # Internal team documentation component
│   ├── antora.yml              # Component descriptor
│   └── modules/
├── ftn-docs.code-workspace     # Multi-root folder list only (tooling in `.vscode/`)
├── .vscode/                    # Editor settings & extension recommendations (playbook root only)
