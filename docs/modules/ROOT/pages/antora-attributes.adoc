...
:description: Guide to using global attributes in FoodTruckNerds documentation for consistent repository and URL references
...
**Renders as**: Visit the https://github.com/FoodTruckNerds[FoodTruckNerds organization] on GitHub.
...
**Renders as**: Clone from https://github.com/FoodTruckNerds/ftn-site[ftn-site repository].
