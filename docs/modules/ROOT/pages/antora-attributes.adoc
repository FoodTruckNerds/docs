...
:description: Guide to using global Antora attributes for consistent repository and URL references
:keywords: antora, attributes, asciidoc, documentation, configuration
:icons: font
:source-highlighter: highlight.js

This guide explains how to use global Antora attributes in this documentation to maintain consistent references to repositories, URLs, and organization information.
...
|`\{repo-docs}`
|`docs`
|Antora coordination repository (this playbook)

|`\{repo-ftn-site}`
|`ftn-site`
|Public website monorepo (SolidStart and Next.js; Antora *Website* component)
...
[source,asciidoc]
----
Visit the {github-org-url}[GitHub organization].
----

**Renders as**: Visit the https://github.com/FoodTruckNerdz[GitHub organization].
...
[source,asciidoc]
----
This documentation is aggregated into the unified
