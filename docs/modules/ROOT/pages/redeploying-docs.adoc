...
This guide explains how to redeploy the documentation site after committing and pushing changes to any of the content repositories.
...
.  Navigate to the **FoodTruckNerdz/docs** repository on GitHub.
